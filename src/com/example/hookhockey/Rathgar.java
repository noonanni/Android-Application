...
import android.widget.Button;
	...
	public class Rathgar extends Activity implements View.OnClickListener  {
		...
		
		{
			...
			setContentView(R.layout.rathgar);
			
			
			WebView engine = (WebView) findViewById(R.id.webrath);
			engine.loadUrl("https://twitter.com/RathgarHC");

			WebView myWebView = (WebView) findViewById(R.id.webrath);
		...
		public void onClick(View view) {
			...
			case R.id.btnMap:
				...
				Intent locate = new Intent(
						Intent.ACTION_VIEW,
						Uri.parse("geo:<53.306289>,<-6.272963>?q=<53.306289>,<-6.272963>(Rathgar Hockey Club+The High School Rathgar)"));
