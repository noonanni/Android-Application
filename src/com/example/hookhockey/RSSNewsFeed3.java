...
public class RSSNewsFeed3 extends Activity {
	...
	private void initViews(){
		etFeedUrl = "http://www.ulsterhockey.com/RSS.aspx?catid=6542";
		...
		btnLoad3.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				SRssParser parser = new SRssParser(etFeedUrl.toString(), getCallback());
				parser.parseAsync();
			}
		});
	}
