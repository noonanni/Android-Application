...
public class Mullingar extends Activity implements View.OnClickListener {
...

	{
		...
		this.root = (FlyOutContainer) this.getLayoutInflater().inflate(R.layout.mullingar, null);

		this.setContentView(root);
		
		
			WebView engine = (WebView) findViewById(R.id.webrail);
		engine.loadUrl("http://www.myhobby.ie/field-sports/westmeath/hockey/mullingar-hockey-club.htm");
	...
	public void onClick(View view) {
		...
		case R.id.btnMap:
			...
			Intent locate = new Intent(
					Intent.ACTION_VIEW,
					Uri.parse("geo:<53.529978>,<-7.346316>?q=<53.529978>,<-7.346316>(Mullingar Hockey Club+Loreto College)"));
