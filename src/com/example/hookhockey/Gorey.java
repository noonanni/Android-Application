...
public class Gorey extends Activity implements View.OnClickListener {
...

	{
		...
		this.root = (FlyOutContainer) this.getLayoutInflater().inflate(R.layout.gorey, null);
	...
	public void onClick(View view) {
		...
		case R.id.btnMap:
			...
			Intent locate = new Intent(
					Intent.ACTION_VIEW,
					Uri.parse("geo:<52.633069>,<-6.234591>?q=<52.633069>,<-6.234591>(Gorey Hockey Club+ Dunhaven)"));
