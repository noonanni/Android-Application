...
public class Boyne extends Activity implements View.OnClickListener {
	...
	public void onClick(View view) {
		...
		case R.id.btnMap:
			...
			Intent locate = new Intent(
					Intent.ACTION_VIEW,
					Uri.parse("geo:<53.71690>,<-6.30130>?q=<53.71690>,<-6.30130>(Boyne Hockey Club+Drogheda Grammar School)"));
