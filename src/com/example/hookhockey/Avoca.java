...
import android.widget.Button;
	...
	public class Avoca extends Activity implements View.OnClickListener  {
		...
		
		{
			...
			this.root = (FlyOutContainer) this.getLayoutInflater().inflate(R.layout.avoca, null);

			this.setContentView(root);
			
			
				WebView engine = (WebView) findViewById(R.id.webrail);
			engine.loadUrl("https://twitter.com/avocahc");
		...
		public void onClick(View view) {
			...
			case R.id.btnMap:
				...
				Intent locate = new Intent(
						Intent.ACTION_VIEW,
						Uri.parse("geo:<53.290056>,<-6.173126>?q=<53.290056>,<-6.173126>(Avoca Hockey Club+Newpark Comprehensive School)"));
