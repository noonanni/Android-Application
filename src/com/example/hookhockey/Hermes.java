...
public class Hermes extends Activity implements View.OnClickListener {
...

	{
		...
		this.root = (FlyOutContainer) this.getLayoutInflater().inflate(R.layout.hermes, null);

		this.setContentView(root);
		
		
			WebView engine = (WebView) findViewById(R.id.webrail);
		engine.loadUrl("https://twitter.com/HermesHC");
	...
	public void onClick(View view) {
		...
		case R.id.btnMap:
			...
			Intent locate = new Intent(
					Intent.ACTION_VIEW,
					Uri.parse("geo:<53.30565>,<-6.200205>?q=<53.30565>,<-6.200205>(Hermes Hockey Club+St Andrews College)"));
