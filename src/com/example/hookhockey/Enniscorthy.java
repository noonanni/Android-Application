...
public class Enniscorthy extends Activity implements View.OnClickListener {
...

	{
		...
		this.root = (FlyOutContainer) this.getLayoutInflater().inflate(
				R.layout.enniscorthy, null);

		this.setContentView(root);

		WebView engine = (WebView) findViewById(R.id.webrail);
		engine.loadUrl("http://www.enniscorthydirectory.com/index.cfm?area=directory&action=directorydetail&DirectoryID=13&menuid=218");
	...
	public void onClick(View view) {
		...
		case R.id.btnMap:
			...
			Intent locate = new Intent(
					Intent.ACTION_VIEW,
					Uri.parse("geo:<52.507174>,<-6.579105>?q=<52.507174>,<-6.579105>(Enniscorthy Hockey Club+ Bellefield, Enniscorthy)"));
