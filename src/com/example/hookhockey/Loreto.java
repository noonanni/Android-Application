...
public class Loreto extends Activity implements View.OnClickListener {
...

	{
		...
		this.root = (FlyOutContainer) this.getLayoutInflater().inflate(R.layout.loreto, null);

		this.setContentView(root);
		
		
			WebView engine = (WebView) findViewById(R.id.webrail);
		engine.loadUrl("https://twitter.com/LoretoHC");
	...
	public void onClick(View view) {
		...
		case R.id.btnMap:
			...
			Intent locate = new Intent(
					Intent.ACTION_VIEW,
					Uri.parse("geo:<53.292531>,<-6.284684>?q=<53.292531>,<-6.284684>(Loreto Hockey Club+Beaufort)"));
