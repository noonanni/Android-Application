...
public class Our_Ladys extends Activity implements View.OnClickListener {
...

	{
		...
		this.root = (FlyOutContainer) this.getLayoutInflater().inflate(R.layout.ourladys, null);

		this.setContentView(root);
		
		
			WebView engine = (WebView) findViewById(R.id.webrail);
		engine.loadUrl("http://www.ourladyshockeyclub.com/");
	...
	public void onClick(View view) {
		...
		case R.id.btnMap:
			...
			Intent locate = new Intent(
					Intent.ACTION_VIEW,
					Uri.parse("geo:<53.300505>,<-6.296377>?q=<53.300505>,<-6.296377>(Our Ladys Hockey Club+Our Ladys Terenure School)"));
