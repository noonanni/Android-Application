...
public class Guinness extends Activity implements View.OnClickListener {
...

	{
		...
		this.root = (FlyOutContainer) this.getLayoutInflater().inflate(R.layout.guinness, null);

		this.setContentView(root);
		
		
			WebView engine = (WebView) findViewById(R.id.webrail);
		engine.loadUrl("http://guinnessladieshockey.com/?page_id=18");
	...
	public void onClick(View view) {
		...
		case R.id.btnMap:
			...
			Intent locate = new Intent(
					Intent.ACTION_VIEW,
					Uri.parse("geo:<53.328134>,<-6.307236>?q=<53.328134>,<-6.307236>(Guinness Hockey Club+Iveagh Garden)"));
